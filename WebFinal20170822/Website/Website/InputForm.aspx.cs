...
namespace Website
{
    public partial class InputForm : System.Web.UI.Page
    {
        ...
        LineInput_BLL_base inputBLL = new LineInput_BLL_base();
        LineInput_BLL inputBLL_ = new LineInput_BLL();
        ...
        protected void lbtnExport_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DataTable dttb = inputBLL_.InputDay_ExportExcel(planid);
        ...
        protected void btnSave_Click(object sender, ImageClickEventArgs e)
        {
            ...
            line_ = inputBLL.LineDayByLine(numLine, planid);
            ...
            if (inputBLL.LineDayUpdate(line_))
            {
        ...
        {
            dt = new DataTable();
            dt = inputBLL.LineDaySelectAll(planid);
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (txtModelA.Text.Equals("Stocking"))
                {
                    //làm cho không sửa được trên giao diện
        ...
        //hàm bắt sự kiện khi ấn vào 1 row được chọn để chỉnh sửa
