<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InputForm.aspx.cs" Inherits="Website.InputForm" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" %>
...
<body onload="time()" style="background-color: white">
    <form id="form1" runat="server">
            ...
            <div id="topbar">
                <div id="topnav">
                    <ul>
                        ...
                        <li>
                            <asp:LinkButton runat="server" ID="lblControl">Control </asp:LinkButton>
                            <ul>
                                <li><a href="AddNewModel.aspx">Add Item</a></li>
                                <li><a href="ChangePassword.aspx">Change password</a></li>
                                <li><a href="ChangeActualInputDay.aspx">Change actual by hour</a></li>
                            </ul>
                        </li>
                        <li>
                            <asp:LinkButton runat="server" ID="btnAddPlan" Width="70px" OnClick="btnAddPlan_Click">Add Plan</asp:LinkButton>
                        </li>
                        <li>
                            <asp:LinkButton runat="server" ID="lbtnExport" Width="70px" OnClick="lbtnExport_Click">Export Excel</asp:LinkButton></li>

                        <li>
                            <asp:DropDownList runat="server" ID="ddlShift" Width="140px" 
                                CssClass="ddlShift" BorderWidth="1px" BackColor="#0291d0" ForeColor="White" Height="25px" OnSelectedIndexChanged="ddlShift_SelectedIndexChanged" AutoPostBack="True" Font-Bold="true">
        ...
        <div id="content" style="width: 100%; color: black; height: 500px; margin-top: 10px; margin-left: 2px" >
            ...
            <asp:GridView runat="server" ID="GridView1" AutoGenerateColumns="False" BorderColor="#CCCCCC" ForeColor="Black" OnRowCreated="GridView1_RowCreated" ShowHeader="false" OnRowDataBound="GridView1_RowDataBound" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" CellSpacing="2">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="From1">
                                <ItemTemplate>
                                    ...
                                    <asp:TextBox ID="TextBoxF11" runat="server" MaxLength="2" Width="20px" Visible="false"></asp:TextBox>
                                    <asp:TextBox ID="TextBoxF12" runat="server" MaxLength="2" Width="20px" Visible="false"></asp:TextBox>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" Width="40px"/>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="From6">
                                <ItemTemplate>
                                    <asp:Label ID="LabelF6" runat="server" Width="40px" Text='<%# Bind("From6") %>'></asp:Label>
