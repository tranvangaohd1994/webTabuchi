<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InputFormNight.aspx.cs" Inherits="Website.InputFormNight" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" %>
        ...
        <div class="wrapper col2">
            <div id="topbar">
                <div id="topnav">
                    <ul>
                        <li>
                            <asp:LinkButton runat="server" ID="lbtnHome" OnClick="lbtnHome_Click">Home</asp:LinkButton></li>
                        <li>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li><a href="ChangePassword.aspx">Change password</a></li>
                                 <li><a href="ChangeActualInputNight.aspx"> Change actual by hour</a></li>
                            </ul>
                        </li>
                        <li>
            ...
            <asp:GridView runat="server" ID="GridView1" AutoGenerateColumns="False" BorderColor="#CCCCCC" ForeColor="Black" OnRowCreated="GridView1_RowCreated" ShowHeader="false" OnRowDataBound="GridView1_RowDataBound" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" CellSpacing="2">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="To6">
                        <ItemTemplate>
                            <asp:Label ID="LabelT6" runat="server" Width="30px" Text='<%# Bind("To6") %>'></asp:Label>
